...
<head>
  ...
  <title>Vehicle Locator - Relatório de Veículos</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <div class="conteudo mx-auto bg-dark">
    <h1 class="bg-dark rounded my-3 p-3 fs-3 text-center">Relatório de Veículos</h1>
      ...
      <tbody>
        <c:forEach items="${veiculos}" var="veiculo">
          <tr>
            ...
            <td>${veiculo.ano}</td>
            <td>${veiculo.cor}</td>
            <td><a class="botaoExcluir" href="/veiculo/excluir?id=${veiculo.id}"><i class="bi bi-trash3-fill"></i></a></td>
            <td><a class="botaoEditar" href="/veiculo/editar/${veiculo.id}"><i class="bi bi-pencil-fill"></i></a></td>
          </tr>
        </c:forEach>
      </tbody>
    </table>
