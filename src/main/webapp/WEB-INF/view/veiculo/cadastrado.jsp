...
<head>
    ...
    <title>Vehicle Locator - Veículo Cadastrado</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="conteudo mx-auto bg-dark">
        ...
        <div class="d-grid gap-2">
          <a class="btn btn-success" href="/veiculo/cadastrar">Cadastrar novo veículo</a>
          <a class="btn btn-success" href="/veiculo/relatorio">Relatório de Veículos</a>
      </div>
    </div>    
</body>
</html>