...
<head>
    ...
    <title>Vehicle Locator - Relatório de Veículos Alugados</title>
</head>
...
<div class="conteudo mx-auto bg-dark">
    <h1 class="bg-dark rounded my-3 p-3 fs-3 text-center">Relatório de Veículos Alugados</h1>
    <hr class="bg-secondary">
    <h2 class="mb-3">Veículos Alugados</h2>
    <table class="table table-dark">
        ...
        <c:forEach items="${aluguel}" var="aluguel">
            <tr>
                <td scope="row">${aluguel.id}</td>
                <td>${aluguel.cliente.nome}</td>
                <td>${aluguel.veiculo.modelo}</td>
                <td>${aluguel.usuario.nome}</td>
                <td><a class="botaoExcluir" href="/aluguel/excluir?id=${aluguel.id}"><i class="bi bi-caret-left-square"></i></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    ...
    <div class="d-grid gap-2">
        <a class="btn btn-success" href="/veiculo/alugar">Alugar Veículo</a>
    </div>
</div>
</body>
</html>