...
<head>
    ...
    <title>Vehicle Locator - Cadastrar Cliente</title>
</head>
    <body class="text-light">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="logo navbar-brand" href="/home" id="navTitle">Vehicle Locator</a>
        ...
        <div class="conteudo mx-auto bg-dark">
            <h1 class="bg-dark rounded my-3 p-3 fs-3 text-center">Cadastro de Clientes</h1>
            ...
            <form method="post" action="/cliente/cadastrado">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="nome" value="${cliente.nome}" placeholder="Nome Completo" required>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" name="cpf" value="${cliente.cpf}" placeholder="CPF" required>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" name="telefone" value="${cliente.telefone}" placeholder="Telefone" required>
                </div>
