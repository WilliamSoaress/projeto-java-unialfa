...
<head>
    ...
    <title>Vehicle Locator - Cliente Cadastrado</title>
</head>
<body class="text-light">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
        <h1 class="navbar-brand" href="/home" id="navTitle">Vehicle Locator</h1>
    ...
    <div class="conteudo mx-auto bg-dark">
        ...
        <div class="d-grid gap-2">
          <a class="btn btn-success" href="/cliente/cadastrar">Cadastrar novo cliente</a>
          <a class="btn btn-success" href="/cliente/relatorio">Relatório de Clientes</a>
      </div>
    </div>    
</body>
</html>