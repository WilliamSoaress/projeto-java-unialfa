...
<head>
    ...
    <title>Vehicle Locator - Relatório de Funcionários</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="conteudo mx-auto bg-dark">
        <h1 class="bg-dark rounded my-3 p-3 fs-3 text-center">Relatório de Usuários</h1>
          ...
          <tbody>
            <c:forEach items="${usuarios}" var="usuario">
              <tr>
                  ...
                  <td>${usuario.login}</td>
                  <td>${usuario.senha}</td>
                  <td><a class="botaoExcluir" href="/usuario/excluir?id=${usuario.id}"><i class="bi bi-trash3-fill"></i></a></td>
                  <td><a class="botaoEditar" href="/usuario/editar/${usuario.id}"><i class="bi bi-pencil-fill"></i></a></td>
              </tr>
          </c:forEach>
          </tbody>
        </table>
