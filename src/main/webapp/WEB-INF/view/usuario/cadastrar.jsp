...
<head>
    ...
    <title>Vehicle Locator - Cadastrar Funcionário</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="conteudo mx-auto bg-dark">
        <h1 class="bg-dark rounded my-3 p-3 fs-3 text-center">Cadastro de Usuários</h1>
        ...
        <form method="post" action="/usuario/cadastrado">
            ...
            <div class="mb-3">
                <input type="text" class="form-control" name="telefone" value="${usuario.telefone}" placeholder="Telefone" required>
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" name="login" value="${usuario.login}" placeholder="Login" required>
            </div>
            <div class="mb-3">
                <input type="password" class="form-control" name="senha" value="${usuario.senha}" placeholder="Senha" required>
            </div>
